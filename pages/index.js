...
return (
  <>
    ...
    <div className="row align-items-center" style={{height:"140px"}}>
      <center style={{fontSize:20,fontWeight:"bold"}}>"CUSTOMER   SATISFACTION   IN   EVERY   DECISION"</center>
    </div>

    <div className="row">
      <h5 className="pt-3 pb-3" style={{paddingLeft:"80px"}}>IT SOLUTIONS & SERVICES</h5>
    </div>
